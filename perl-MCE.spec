...
Source0  : https://cpan.metacpan.org/authors/id/M/MA/MARIOROY/MCE-1.891.tar.gz
...
This document describes MCE version 1.891.
...
%prep
%setup -q -n MCE-1.891
cd %{_builddir}/MCE-1.891
pushd ..
cp -a MCE-1.891 buildavx2
popd
